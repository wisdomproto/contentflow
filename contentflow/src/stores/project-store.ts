...
- 한 섹션이 3분 이상 길어지기`,
    ...
    const dbProject = {
      ...
      reference_files: newProject.reference_files,
      bgm_files: newProject.bgm_files,
      reference_summary: newProject.reference_summary,
      funnel_config: newProject.funnel_config,
      ga4_config: newProject.ga4_config,
      imported_strategy: newProject.imported_strategy,
      writing_guide_global: newProject.writing_guide_global,
      writing_guide_blog: newProject.writing_guide_blog,
      writing_guide_instagram: newProject.writing_guide_instagram,
      writing_guide_threads: newProject.writing_guide_threads,
      writing_guide_youtube: newProject.writing_guide_youtube,
      target_languages: newProject.target_languages,
  ...
  updateProject: async (projectId, updates) => {
    ...
    const DB_COLUMNS = new Set([
      ...
      'reference_files', 'bgm_files', 'reference_summary',
