...
## Chunk 5: US-Korean — 미국 한인 디아스포라 특별 트랙 (2026-06-01 신설, 병렬 진입 가능)

**모델**: EN(영어권 현지인)과 별개 축. ① 한국어 자산 재활용 ② 방한 진료(방학) ③ **본사 직접 한국어 클로징 → 현지 에이전시 불필요**(hub-spoke 예외) → 기존 4축보다 진입 장벽 낮아 KR 본진과 거의 동급 조기 진입 가능.

**핵심 결정**: 메인 유료 = Meta 리드젠(85%) / 구글 = 브랜드방어 + 미주중앙 PR / 1차 지역 = LA·OC / 1차 목표 = 상담 DB / 예산 = 월 $1~3k 검증. 작전 페이지: `187-us-korean-operations.html`.

### 5.1 셋업 (W1-2)
- [ ] **5.1.1 Meta 광고계정·픽셀·리드폼** — LA 한인 타깃(언어 한국어 + 관심사 한국육아 + LA ZIP + 35~49 여성)
- [ ] **5.1.2 인스타·유튜브 @187growup 미국 한인 발행 시작** (한국어 재활용, 번역 불필요)
- [ ] **5.1.3 카카오 상담 채널 + 응대 스크립트** (1차 상담 채널)
- [ ] **5.1.4 dr187growup.com 미국 한인 랜딩** — 예상키 도구 + 방한 진료 안내 + 카톡 CTA
- [ ] **5.1.5 의료광고법 카피 사전심의 확인** (한국 의원 집행 — 효과보증·후기 익명화)

### 5.2 런칭·검증 (W3-8)
- [ ] **5.2.1 Meta 리드젠 런칭** (95% 몰빵) + 소재 A/B 5종
- [ ] **5.2.2 미주중앙일보 애드버토리얼 1편** (채용현 원장 기고 — 구글 색인 PR 자산)
- [ ] **5.2.3 winning 소재·리타깃 + CPL 최적화**
- [ ] **5.2.4 리드 품질·DFlo 앱 설치율 모니터링**

### 5.3 시즌 클로징·확장 (W9-12+)
- [ ] **5.3.1 방학 시즌(여름 6~8·겨울 12~1) 방한 진료 클로징 캠페인**
- [ ] **5.3.2 LA 공식 확립 후 NJ 버겐카운티 복제 확장**
- [ ] **5.3.3 미주중앙 PR SEO 랭킹 → 구글 브랜드검색 비중 확대**

### Chunk 5 완료 체크
- [ ] **G5.1**: Meta CPL 안정 범위 + 월 상담 DB 25+ 건
- [ ] **G5.2**: 상담 → DFlo 앱 → 방한 진료 funnel 1건+ end-to-end
- [ ] **G5.3**: 미주중앙 애드버토리얼 구글 색인 확인
